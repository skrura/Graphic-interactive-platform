...
import com.yh.common.tess4j.Tess4jClient;
...
import com.yh.model.wemedia.pojos.WmSensitive;
import com.yh.model.wemedia.pojos.WmUser;
import com.yh.utils.common.SensitiveWordUtil;
import com.yh.wemedia.mapper.WmChannelMapper;
import com.yh.wemedia.mapper.WmNewsMapper;
import com.yh.wemedia.mapper.WmSensitiveMapper;
import com.yh.wemedia.mapper.WmUserMapper;
...
public class WmNewsAutoScanServiceImpl implements WmNewsAutoScanService {
    ...
    public void autoScanWmNews(Integer id) {
        ...
        if(wmNews.getStatus().equals(WmNews.Status.SUBMIT.getCode())){
            ...
            //2.审核文本内容  阿里云接口   没钱买审核暂代成功
            //boolean isTextScan = handleTextScan((String) textAndImages.get("content"),wmNews);
            //if(!isTextScan)return;

            //3.审核图片  阿里云接口  没钱买审核暂代成功
